 ...
 * Modified work Copyright 2018 Asep Sulaeman
 *
...
package com.asepsulaeman.asulefab;
...
public class AsuleFab extends FloatingActionButton {

    private final Property<AsuleFab, Float> ANIMATION_PROPERTY =
            new Property<AsuleFab, Float>(Float.class, "animation") {

                @Override
                public void set(AsuleFab object, Float value) {
                    mAnimationFactor = value;
                    postInvalidateOnAnimation();
                }

                @Override
                public Float get(AsuleFab object) {
                    return 0f;
                }
            };
    ...
    public AsuleFab(Context context) {
        this(context, null, 0);
    }

    public AsuleFab(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AsuleFab(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private static class SavedState extends View.BaseSavedState {
        ...
        /**
         * Constructor called from {@link AsuleFab#onSaveInstanceState()}
*/
...
*/
        ...
        public String toString() {
            return AsuleFab.class.getSimpleName() + "." + SavedState.class.getSimpleName() + "{"
